...
import { IoChevronDownOutline, IoChevronForward, IoLogOutOutline } from 'react-icons/io5';
import type { MenuItem } from '@/interface/sidebar.interface';
import DeleteModal from '@/components/AlertModal';
import { useRouter } from 'next/navigation';
import { clearAllCookies } from '@/service/cookie';
  ...
  return (
    ...
    >
      ...
      <DeleteModal
        ...
        primaryMessage="Logout"
        secondaryMessage="Are you sure you want to logout ?"
        className="max-w-xl"
      />
    </div>
  );
